	...
	<div id="middle" style="height:1050px">
		<div id="left">
           <%@include file="nav.jsp"%>
			...
			<div id="content" style=" margin-top:10px;width:620px;background-color: white;height:940px">
				<h3 align="center">欢迎您参加首届全国玉米分子生物学大会，您的信息修改成功。</h3>

				<form id="formm" action="allshow.action"></form>
				</br>
				</br></br></br>
			    <span align="center">&nbsp;&nbsp;&nbsp;&nbsp;<a onClick="formm.submit()" style="color:#750075;">查看所有已提交摘要信息 </a></span>
			</div>
