...
--><div id="logins">
<br/>
<div id="wall" style="font-size:21px"><image src="trr.gif"width="20px"height="20px"/>当前用户信息</div> 
<br/>
...
<tr >
<td border="1"   class="tab1"align="center" bgcolor="#CFEEF8" style="font-size:13px"><h3>摘要标题</h3></td>
...
<tr>
<td border="1"   class="tab1"align="center" bgcolor="#CFEEF8"style="font-size:13px"><h3>作者名单</h3></td>
<td border="1"   class="tab1">&nbsp;&nbsp;&nbsp;<textarea readonly="readonly" style="margin-top:7px;width:500px;;height:45px; max-width:500px;max-height:45px;border:0px;" name="abstracter"><%=result.getString(13) %></textarea>
 
</tr>
<tr>
<td border="1"   class="tab1"align="center" bgcolor="#CFEEF8" style="font-size:13px"><h3>作者机构</h3></td>
<td border="1"   class="tab1" >&nbsp;&nbsp;&nbsp;<textarea readonly="readonly" style="margin-top:7px;width:500px;;height:45px; max-width:500px;max-height:45px;border:0px;" name="abstracter"><%=result.getString(14) %></textarea>

 
</tr>

<tr>
<td border="1"   class="tab1"align="center" bgcolor="#CFEEF8"style="font-size:13px"><h3>摘要</h3></td>
...
<br/>
		<% if(mark.equals("register")){%>
	        ...
	        <span align="center" style="float:right;margin-right:10px;"><a onClick="formm.submit()" style="color:#750075;">返 回</a></span>
		<% }
		if(mark.equals("tour")){
		%>
		    <form id="formxxx" action="allshow_2.action"></form>
	        <span align="center" style="float:right;margin-right:10px;"><a onClick="formxxx.submit()" style="color:#750075;">返 回</a></span>
		<%} %>
